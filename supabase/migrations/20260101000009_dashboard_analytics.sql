-- 20260101000009_dashboard_analytics.sql
-- Analytics RPCs + seniority columns for the Phase 4 dashboard.
-- Twin of infra/supabase/010_dashboard_analytics.sql — keep both in sync.
